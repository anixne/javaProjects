...
public class FileExplorer{
  ...
  public void start(){
    ...
    System.out.println("Welcome to Java File explorel. Type help to see available commands");
    ...
    while (true) {
      ...
      try{
        switch(command.toLowerCase()){
          ...
          default -> System.out.println("Unknown command. Type help to get more info");
        }
        catch (Exception e){
    ...
    for (File file : files){
      ...
      System.out.printf("%s%sn", type, file.getName());
  ...
  private void changeDirectory(String path){
    if(path.isEmpty()){
      System.out.println("Please specify a direction name.");
      return;
    }
  ...
  private void deleteFileOrDirectory(String name){
    if (name.isEmpty()){
      System.out.println("Please specify a file that you want to delete");
      return;
    }
